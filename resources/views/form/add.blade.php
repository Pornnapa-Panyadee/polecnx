                        ...
                        <div class="col-md-10 mx-auto  justify-content-center">
                          <div class="card table-card">
                            <div class="card-header">
                              <div class="row">
                                <div align="right">
                                  <a href="{{ url('/flood24/table')}}"><button class="btn btn-success">ตารางสรุปข้อมูล</button></a>
                              </div>
                                        ...
                                        <div class="form-check mb-3">
                                          <div class="row" style="margin-left: 15px;" >
                                            <div class="col-md-12 col-xl-2">
                                              <input class="form-check-input" type="radio" id="home" name="affected_area" value="บ้าน">
                                            ...
                                            <div class="col-md-12 col-xl-2">
                                              ...
                                              <label class="text" for="other"> อื่นๆ โปรดระบุ</label>
                                            </div>
                                          </div>
