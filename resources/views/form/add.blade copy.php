                                 ...
                                 <div class="container mt-2" >
                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-check mb-3">
                                            <input class="form-check-input" type="radio" id="residential" name="affected_area" value="บ้าน/ที่อยู่อาศัย/สถานที่">
                                            <label class="form-check-label" for="residential">
                                                บ้าน/ที่อยู่อาศัย/สถานที่
                                            </label>
                                        </div>
                                        <!-- บ้านเลขที่ -->
                                        <div class="row" style="margin-left: 15px;" >
                                          ...
                                          <div class="col-md-12 col-xl-3">
                                            <label for="road_number" class="form-label">ซอย</label>
                                            <input type="text" class="form-control" id="road_number" name="road_number" placeholder="ซอย" required>
                                          </div>
                                          <div class="col-md-12 col-xl-2">
                                            <label for="village_number" class="form-label">หมู่ที่</label>
                                            <input type="text" class="form-control" id="village_number" name="village_number" placeholder="หมู่ที่" required>
                                          </div>
                                        ...
                                        <div class="row" style="margin-left: 15px;" >
                                          ...
                                          <div class="col-md-12 col-xl-4">
                                            ...
                                            <input type="text" class="form-control" id="province" name="province" placeholder="อำเภอ" value="เชียงใหม่"> 
                                          </div>
                                        </div>

                                        <!-- ถนน -->
                                        <div class="form-check mb-3" style="margin-top: 15px;" >
                                            <input class="form-check-input" type="radio" id="road" name="affected_area" value="ถนน">
                                        ...
                                        <div class="row" style="margin-left: 15px;" >
                                          <div class="col-md-12 col-xl-3">
                                            <label for="road_name" class="form-label">ชื่อถนน</label>
                                            <input type="text" class="form-control" id="road_name" name="road_name" placeholder="ชื่อถนน" required>
                                          </div>
                                          <div class="col-md-12 col-xl-3">
                                            <label for="subdistrict" class="form-label">ตำบล</label>
                                            <input type="text" class="form-control" id="subdistrict" name="subdistrict" placeholder="ตำบล" required>
                                        ...
                                        <!-- อื่นๆ ระบุ -->
                                        <div class="form-check mb-3" style="margin-top: 15px;">
                                            <input class="form-check-input" type="radio" id="other" name="affected_area" value="อื่นๆ">
                                        ...
                                        <div class="row"  style="margin-left: 15px;">
                                              <div class="col-md-12 col-xl-3">
                                                <input type="text" class="form-control mt-2" id="other_detail" name="other_detail" placeholder="ระบุรายละเอียด">
                                              </div>
                                              <div class="col-md-12 col-xl-3">
                                                <input type="text" class="form-control mt-2" id="subdistrict" name="subdistrict" placeholder="ตำบล">
                                              </div>
                                              <div class="col-md-12 col-xl-3">
                                                <input type="text" class="form-control mt-2" id="district" name="district" placeholder="อำเภอ">
                                              </div>
                                              <div class="col-md-12 col-xl-3">
                                                <input type="text" class="form-control mt-2" id="province" name="province" value="เชียงใหม่">
                                              </div>
                                        </div>
                                        <hr></hr>
                                        ...
                                        <div class="row">
                                          <div class="col-md-12 col-xl-12">
                                            <input type="number" class="form-control" id="place" name="place" placeholder="กรอกสถานที่ใกล้เคียง / สถานที่สำคัญ" >
                                          </div>
                                        </div>
                                        ...
                                        <div class="row">
                                          <div class="col-md-12 col-xl-12">
                                            <input type="number" class="form-control" id="tool" name="tool" placeholder="กรอกโครงสร้างที่ทำเครื่องหมาย" required>
                                          </div>
                                        </div>
